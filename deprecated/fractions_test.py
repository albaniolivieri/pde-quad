...
print(
    "Fraction decomposition:", frac_decomp.pde[0][1], "\nRelations:", frac_decomp.rels
)
...
print(
    "Checking if sympy decomposition is equal to our decomposition:",
    f"\n{final_expr} - ({sympy_decomp}) =",
    simplify(expand(final_expr) - expand(sympy_decomp)),
)
