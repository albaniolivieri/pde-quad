...
get_quadratization([(psi, psi_t), (theta, theta_t), (y_0, y_0_t), (y_1, y_1_t)], [y_1**2, y_0 * y_1, y_0 * y_1**2, psi * y_0 * y_1, psi * y_0 * y_1**2, D(theta, s) * y_1, theta * y_1, D(theta, s, 2) * y_1], 5) 