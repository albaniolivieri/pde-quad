...
ut4 = D(u, x)**3 + u**3
print('\nD(u,x)**3 + u**3')
tests.append(test_try_quadratize([(u, ut4)], 3, by_order_degree, search_alg='b&b'))
...
ut3 = D(u, x)**3 
print('\nD(u, x)**3')
tests.append(test_try_quadratize([(u, ut3)], 3, by_order_degree, max_der_order=3, search_alg='b&b'))
